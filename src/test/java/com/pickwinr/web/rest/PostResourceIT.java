...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().link(DEFAULT_LINK).commentCount(DEFAULT_COMMENT_COUNT).content(DEFAULT_CONTENT);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().link(UPDATED_LINK).commentCount(UPDATED_COMMENT_COUNT).content(UPDATED_CONTENT);
        return post;
    }
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.link(UPDATED_LINK).commentCount(UPDATED_COMMENT_COUNT).content(UPDATED_CONTENT);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.link(UPDATED_LINK).commentCount(UPDATED_COMMENT_COUNT).content(UPDATED_CONTENT);
